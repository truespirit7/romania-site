...
Redux::setSection( $opt_name, array(
    ...
    'fields'     => array(
        ...
        array(
            ...
            'desc' => __( 'Important: The progress bar will only display on pages that make use of the WordPress function the_content(), regardless of the post type. For instance, a bbPress forum post does not use the_content() and thus will not display a progress bar. Note: if there are no options displayed here, that means your custom post types were not detected by WTR, in which case you can use the freeform field below to manually enter them.', 'wtr' ),
            'data'     => 'post_types',
            'args' 	   => array(
            				'public' => true, 
            				'_builtin' => false,
        ...
        array(
            ...
            'type'     => 'text',
            'title'    => __( 'Custom Post Types', 'wtr' ),
            'subtitle' => __( 'Manually enter the slug of your custom post types if they were not detected above, in a comma-separated list.', 'wtr' ),
            'desc'     => __( 'Example: "events, game_reviews, another_cpt_slug, as_many_as_you_want" (do not include the quotes)', 'wtr' ),
            'default'  => '',
        ),
        array(
        ...
        array(
            ...
            'type'     => 'switch',
            'title'    => __( 'RTL', 'wtr' ),
            'subtitle' => __( 'Progress bar will move from right to left as the user scrolls down the page.', 'wtr' ),
            'default'  => false,
        ...
        array(
            ...
            'type'     => 'switch',
            'title'    => __( 'Non-Touch Devices', 'wtr' ),
            'subtitle' => __( 'Display on standard desktops and laptops', 'wtr' ),
            'default'  => true,
        ),
        array(
            'id'       => 'progress-touch',
...
Redux::setSection( $opt_name, array(
    ...
    'fields'     => array(
        ...
        array(
            ...
            'desc' => __( 'Important: The time label will only display on pages that make use of the WordPress function the_content(), regardless of the post type. For instance, a bbPress forum post does not use the_content() and thus will not display a time label. Note: if there are no options displayed here, that means your custom post types were not detected by WTR, in which case you can use the freeform field below to manually enter them.', 'wtr' ),
            'data'     => 'post_types',
            'args'     => array(
                            'public' => true, 
                            '_builtin' => false,
        ...
        array(
            'id'            => 'time-ppm',
            'type'          => 'slider',
            'title'          => __( 'Pictures Per Minute', 'wtr' ),
            'subtitle'       => __( 'Set this to 0 if you do not want to take pictures into account when calculating reading time.', 'wtr' ),
            'default'       => 5,
            'min'           => 0,
            'step'          => 1,
            'max'           => 20,
        ...
        array(
            ...
            'type'     => 'text',
            'title'    => __( 'Singular Format', 'wtr' ),
            'subtitle' => __( 'Optionally specify a different singular format', 'wtr' ),
            'desc'     => __( 'This will only be used if the read time is 1 minute', 'wtr' ),
            'default'  => '',
        ),
        array(
            'id'       => 'time-method',

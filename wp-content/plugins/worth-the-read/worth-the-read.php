...
function wtr_custom_html($post) {
	...
	<p class="howto"><?php _e( 'Use # as a placeholder for the number. Example: "# min read" becomes "12 min read"', 'wtr' )?></p>
    <?php
}
...
function wtr_time_commitment() {
	...
	$time_format = empty($options['time-format']) ? __('# min read','wtr') : $options['time-format'];
